...
const Container = () => {
  return (
    <div className="container-style" style={{ width: '1200px', height: '3500px', top: '100px', left: '2850px', position: 'absolute' }}>
      {/* Lorem Ipsum Section */}
      <div className="dolor">
      ...
      <div className="items-and-filters" style={{ width: '1150px', height: '88px', top: '400px', left: '20px', position: 'absolute' }}>
      ...
      <div className="image-section" style={{ width: '750px', top: '500px', left: '100px', position: 'absolute' }}>
      ...
      <div className="black-container" style={{ width: '1150px', height: '850px', top: '2600px', position: 'absolute' }}>
